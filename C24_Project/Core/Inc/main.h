...
/* Private defines -----------------------------------------------------------*/
#define CSX_Pin GPIO_PIN_15
#define CSX_GPIO_Port GPIOC
#define RESX_Pin GPIO_PIN_0
#define RESX_GPIO_Port GPIOA
...
#define state_EXTI_IRQn EXTI4_IRQn
#define DHT11_Pin GPIO_PIN_9
#define DHT11_GPIO_Port GPIOA
#define choose_time_Pin GPIO_PIN_3
#define choose_time_GPIO_Port GPIOB
#define choose_time_EXTI_IRQn EXTI3_IRQn
